...
public class TagController {
    ...
    @GetMapping("/blog-tags/input")
    public String input(Model model) {
        model.addAttribute("tag", new Tag());
        return "admin/blog-addTag";
    }

    @GetMapping("/blog-tags/{id}/input")
    ...
    @GetMapping("/blog-tags/{id}/delete")
